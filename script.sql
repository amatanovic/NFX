...
insert into proizvod (naziv, cijena, slika, opg, kategorija) values ('Grašak', 7.00 , 'slike/bundeva1.jpg', 4 , 2);
insert into proizvod (naziv, cijena, slika, opg, kategorija) values ('Bijeli krumpir', 2.50 , 'slike/krumpir3.jpg', 4 , 2);
insert into proizvod (naziv, cijena, slika, opg, kategorija) values ('Špinat', 4.50 , 'slike/spinat1.jpg', 4 , 2);
insert into proizvod (naziv, cijena, slika, opg, kategorija) values ('Mrkva', 5.00 , 'slike/mrkva3.jpg', 4 , 2);
insert into proizvod (naziv, cijena, slika, opg, kategorija) values ('Rajčica', 9.50 , 'slike/rajcica2.jpg', 4 , 2);
insert into proizvod (naziv, cijena, slika, opg, kategorija) values ('Paprika babura (razne boje)', 7.00 , 'slike/paprika3.jpg', 4 , 2);
insert into proizvod (naziv, cijena, slika, opg, kategorija) values ('Jagode (korpica)', 17.00 , 'slike/jagoda2.jpg', 5 , 1);
insert into proizvod (naziv, cijena, slika, opg, kategorija) values ('Višnje', 14.00 , 'slike/visnja3.jpg', 5 , 1);
insert into proizvod (naziv, cijena, slika, opg, kategorija) values ('Lubenica', 5.00 , 'slike/lubenica1.jpg', 5 , 1);
insert into proizvod (naziv, cijena, slika, opg, kategorija) values ('Crveni luk', 2.50 , 'slike/luk1.jpg', 5 , 2);
insert into proizvod (naziv, cijena, slika, opg, kategorija) values ('Rotkvica', 10.00 , 'slike/rotkvica3.jpg', 5 , 2);
insert into proizvod (naziv, cijena, slika, opg, kategorija) values ('Kruške', 8.00 , 'slike/kruska2.jpg', 8 , 1);
insert into proizvod (naziv, cijena, slika, opg, kategorija) values ('Šljive', 11.00 , 'slike/sljiva2.jpg', 8 , 1);
insert into proizvod (naziv, cijena, slika, opg, kategorija) values ('Bijelo grožđe', 9.00 , 'slike/grozdje1.jpg', 8 , 1);
insert into proizvod (naziv, cijena, slika, opg, kategorija) values ('Crno grožđe', 11.00 , 'slike/grozdje2.jpg', 8 , 1);
insert into proizvod (naziv, cijena, slika, opg, kategorija) values ('Crno vino', 11.00 , 'slike/vino3.jpg', 8 , 3);
insert into proizvod (naziv, cijena, slika, opg, kategorija) values ('Rakija od šljive', 30.00 , 'slike/rakija2.jpg', 8 , 3);
