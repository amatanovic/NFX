drop database if exists opg1;
create database opg1 character set utf8 collate utf8_general_ci;
use opg1;
...
insert into opg (naziv, paypal, kratakopis, avatar, korisnik) values ('OPG Vilček', NULL, 'Obiteljsko poljoprivredno gospodarstvo Vilček nalazi se u Belom Manastiru. Bavimo se proizvodnjom i uzgojem raznog voća i povrća. Posebno smo bazirani na uzgoj jabuka. Proizvodimo i prirodni sok od rajčice koji također možete vidjeti u našoj ponudi.', 'slike/avatar5.jpg', 2);
insert into opg (naziv, paypal, kratakopis, avatar, korisnik) values ('OPG Leh', NULL, 'Leh obiteljsko poljoprivredno gospodarstvo bavi se uzgojem povrća (grašak, krumpir, špinat, mrkva, rajčice, paprika). U cjelokupnoj proizvodnji sudjeluju svi članovi obitelji Leh, od najstarijih (72 godine) pa do najmlađih (11 godina). OPG se nalazi na području Valpova.', 'slike/avatar4.jpg', 4);
insert into opg (naziv, paypal, kratakopis, avatar, korisnik) values ('OPG Stojanović', NULL, 'OPG Stojanović bavi se uzgojem jagoda, višanja i lubenica. Također, uvelike se bavimo proizvodnjom luka i rotkvica. Imanje obitelji Stojanović nalazi se na području Donjeg Miholjca. ', 'slike/avatar8.jpg', 5);
insert into opg (naziv, paypal, kratakopis, avatar, korisnik) values ('OPG Kujavec', NULL, 'Obitelj Kujavec na svojim prostorima vinograda uzgaja vinovu lozu, kruške i šljive. U svojoj ponudi Vam također nudimo i proizvode nastale od uzgoja ovoga voća, a to su razne rakije i vino. Naravno, rakija je među nama poznata i kao lijek, a čaša crnog vina dnevno poboljšat će Vašu krvnu sliku.', 'slike/avatar3.jpg', 8);
